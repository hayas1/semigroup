...
/// A [`Semigroup`](crate::Semigroup) [op construction](crate::SemigroupOp) that returns `true` if both values are `true`.
/// # Properties
/// <!-- properties -->
///
/// # Examples
...
#[semigroup_op(idempotent, monoid, commutative, identity = Self(true))]
