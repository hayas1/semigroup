...
/// A [`Semigroup`](crate::Semigroup) [op construction](crate::SemigroupOp) that returns the maximum value.
/// # Properties
/// <!-- properties -->
///
/// # Examples
...
#[semigroup_op(idempotent, monoid, commutative, identity = Self(T::min_value()), monoid_where = "T: num::Bounded")]
