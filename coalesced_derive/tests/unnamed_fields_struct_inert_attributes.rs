...
#[derive(Coalesce)]
struct Config(
    #[coalesced(with = coalesced::strategy::Overwrite)] &'static str,
    Option<i32>,
);

#[test]
fn test_derive_coalesce_unnamed_fields_struct_inert_attributes() {
...
#[test]
fn test_derive_extension_unnamed_fields_struct_inert_attributes() {
