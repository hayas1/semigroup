...
enum Config {
    ...
    Unnamed(#[coalesced(with = coalesced::strategy::Overwrite)] &'static str),
}

#[test]
fn test_derive_coalesce_enum_unit_inert_attributes() {
...
#[test]
fn test_derive_coalesce_enum_named_inert_attributes() {
...
#[test]
fn test_derive_coalesce_enum_unnamed_inert_attributes() {
...
#[test]
fn test_derive_extension_enum_unit_inert_attributes() {
...
#[test]
fn test_derive_extension_enum_named_inert_attributes() {
...
#[test]
fn test_derive_extension_enum_unnamed_inert_attributes() {
