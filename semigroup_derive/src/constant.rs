...
pub struct Constant {
    ...
    pub path_construction_semigroup: Path,
...
impl ConstantExt for External {
    fn constant() -> Constant {
        Constant {
            ...
            path_construction_semigroup: parse_quote! {::semigroup::Op},
            path_construction_annotated: parse_quote! {::semigroup::AnnotatedOp},
            path_construction_monoid: parse_quote! {::semigroup::MonoidOp},
...
impl ConstantExt for Internal {
    fn constant() -> Constant {
        Constant {
            ...
            path_construction_semigroup: parse_quote! {crate::Op},
            path_construction_annotated: parse_quote! {crate::AnnotatedOp},
            path_construction_monoid: parse_quote! {crate::MonoidOp},
            default_type_param: parse_quote! { A },
